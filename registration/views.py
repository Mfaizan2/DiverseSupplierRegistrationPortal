...
def UploadExcelFile(request):
    ...
    mbe_business = data["Is your company certified by the National Minority Supplier Development Council (NMSDC) or one of its affiliates?"]
    ...
    mbe_certification_file = data['MOB Certification Upload']

    wbe_business = data[
        "Is your company certified by the Women Business Enterprise National Council Development Council (WBENC) or one of its affiliates?*"]
    ...
    wbe_certification_file = data['WOB Certification Upload']
    ...
    vb_certification_file = data['VOB Expiration Date']
    ...
    other_certification_file = data['OC Certification Upload']
    ...
    for index in range(0, len(campany_name)):
        ...
        if mbe_expirationDate[index]:
            ...
            mbe_expirationDate[index] = datetime.date(day=int(temp_date[1]), month=int(temp_date[0]), year=int(temp_date[2]))
            businessAndCertification.expiration_date = mbe_expirationDate[index]
            print("mbe_expirationDate[index]", mbe_expirationDate[index])
        businessAndCertification.certification_file = mbe_certification_file[index]
        businessAndCertification.save()
        ...
        if wbe_expirationDate[index]:
            ...
            wbe_expirationDate[index] = datetime.date(day=int(temp_date[1]), month=int(temp_date[0]), year=int(temp_date[2]))
            womenOwnedBusiness.expiration_date = wbe_expirationDate[index]
        womenOwnedBusiness.certification_file = wbe_certification_file[index]
        womenOwnedBusiness.save()
        ...
        if vb_expirationDate[index]:
            ...
            vb_expirationDate[index] = datetime.date(day=int(temp_date[1]), month=int(temp_date[0]), year=int(temp_date[2]))
            veteranOwnedBusiness.expiration_date = vb_expirationDate[index]
        veteranOwnedBusiness.certification_file = vb_certification_file[index]
        veteranOwnedBusiness.save()
        ...
        if other_certification_expirationDate[index]:
            ...
            other_certification_expirationDate[index] = datetime.date(day=int(temp_date[1]), month=int(temp_date[0]),
                                                                      year=int(temp_date[2]))
            otherCertification.expiration_date = other_certification_expirationDate[index]
        otherCertification.certification_file = other_certification_file[index]
        otherCertification.save()
        ...
        if certificationExpectedDate[index]:
            ...
            certificationExpectedDate[index] = datetime.date(day=int(temp_date[1]), month=int(temp_date[0]),
                                                             year=int(temp_date[2]))
        ...
        print("Zeeshan")
        print(isOem, AbcSupplier, anyOtherTier1AutomotiveCompany[index], VMI, JIT, automotive1, automotive2, automotive3)
