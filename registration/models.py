...
class GeneralContactInfo(models.Model):
    ...
    campany_fb = models.CharField(max_length=255, null=False, blank=False, default='')
    campany_linkedin = models.CharField(max_length=255, null=False, blank=False, default='')
    campany_twitter = models.CharField(max_length=255, null=False, blank=False, default='')
    campany_insta = models.CharField(max_length=255, null=False, blank=False, default='')
